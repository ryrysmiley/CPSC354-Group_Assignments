...
instance Print AbsNumbers.Exp where
  prt i = \case
    ...
    AbsNumbers.Divide exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "/"), prt 2 exp2])
    AbsNumbers.Mod exp1 exp2 -> prPrec i 1 (concatD [prt 1 exp1, doc (showString "%"), prt 2 exp2])
    AbsNumbers.Neg exp -> prPrec i 2 (concatD [doc (showString "-"), prt 0 exp])
    AbsNumbers.Abs exp -> prPrec i 2 (concatD [doc (showString "|"), prt 0 exp, doc (showString "|")])
    AbsNumbers.Expo exp1 exp2 -> prPrec i 2 (concatD [prt 2 exp1, doc (showString "^"), prt 3 exp2])
    AbsNumbers.Paren exp -> prPrec i 3 (concatD [doc (showString "("), prt 0 exp, doc (showString ")")])
